        ...
        <div class="row justify-content-lg-center">
            <div class="col-lg-10">
                ...
                <div class="row align-items-center mb-5">
                    <div class="col">
                        <h3 class="mb-0"><?php echo e(count($videos)); ?> видео</h3>
                    </div>
                    <!-- End Col -->
                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="avatar avatar-xl avatar-circle avatar-centered mb-3">
                                            <img class="avatar-img" src="/storage/<?php echo e($video->path_preview); ?>"
                                                 alt="Image Description">
                                        </div>
                                        <!-- End Avatar -->

                                        <h3 class="mb-1">
                                            <a class="text-dark" href="#"><?php echo e($video['title']); ?></a>
                                        </h3>

                                        <!-- Badges -->
                                        <ul class="list-inline mb-0">
                                            <?php if($video->show_main): ?>
                                            ...
                                            <li class="list-inline-item"><a
                                                    ...
                                                    href="#"><?php echo e($video['category']); ?></a></li>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td><a href="<?php echo e(route("category.delete:id", $cat['id'])); ?>" class="btn btn-danger">
                                        Удалить
                                    </a></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal fade" id="newProjectModal" tabindex="-1" aria-labelledby="newProjectModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Step Form -->
                <form action="<?php echo e(route("video.add")); ?>" enctype="multipart/form-data" method="post" class="js-step-form" data-hs-step-form-options='{
                            ...
                            <div class="row">
                                <div class="">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input name='category' id="input" class='some_class_name form-control' placeholder='Введи сюда категорию' data-whitelist="<?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($item['title']); ?>, <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" >
                                       </div>
                                    <script>
...
<?php /**PATH /Users/nikita/PhpstormProjects/hans/resources/views/admin/videos.blade.php ENDPATH**/ ?>