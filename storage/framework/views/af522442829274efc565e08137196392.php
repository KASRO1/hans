        ...
        <div class="container">
            ...
            <nav class="header-nav">
                <ul class="header-nav__list">
                    ...
                    <li class="header-nav__list__item">
                        <a href="<?php echo e(route("all.video")); ?>"
                           class="header-nav__list__item-link">
                            videos
                        </a>
                    </li>
            ...
            <div class="header-welcome">
                ...
                <div class="header-welcome__wrap-btn">
                    ...
                    <a href="<?php echo e(route("redirect:btn_name", "onlyfans_vip")); ?>"
                       target="_blank"
                    ...
                    <a href="<?php echo e(route("redirect:btn_name", "onlyfans_free")); ?>"
                       target="_blank"
                       class="btn-subscr relative header-welcome__wrap-btn__btn">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             class="btn-subscr__icon" width="47.112"
                ...
                <div class="header-welcome__wrap-btn">
                    ...
                    <a href="<?php echo e(route("redirect:btn_name", "fansly")); ?>"
                       target="_blank"
...
<?php /**PATH /Users/nikita/PhpstormProjects/hans/resources/views/elements/header.blade.php ENDPATH**/ ?>