        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                 ...
                 <form class="d-flex col-6 gap-2" method="get" action="{{route("admin")}}">
                                        ...
                                        <td>
                                            ...
                                            <a class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    <h5 class="text-inherit mb-0">{{$visit['btn']}}</h5>
                                                </div>
                                            </a>
                                            <!-- End Media -->
                                        </td>
                        ...
                        <div class="d-lg-flex align-items-lg-center">
                            ...
                            <div class="flex-grow-1 ms-lg-3">
                                ...
                                <div class="d-flex align-items-center">
                                    <h3 class="mb-0">{{$totalUniqueVisits}}</h3>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                @foreach($visitsByCountry as $user)
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img class="avatar-xss avatar-circle"
                                                         src="./assets/vendor/flag-icon-css/flags/1x1/{{strtolower($user['country'][0] . $user['country'][1]) }}.svg"
                                                        >
                                                </div>
                                                <div class="flex-grow-1 ms-2">{{$user['country']}}</div>
                                            </div>
                                        </td>
                                        <td>{{$user['unique_visits']}}</td>
