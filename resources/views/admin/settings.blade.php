                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route("settings.save")}}" method="post">
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Ссылка на Onlyfans free </label>

                                    <div class="col-sm-9">
                                        <input  class="form-control" name="onlyfans_vip" id="emailLabel" placeholder="OnlyFansFree" aria-label="Email" value="{{$settings['onlyfans_free']}}">
                                    </div>
                                </div>
                                <!-- End Form -->
                                <div class="row mb-4">
                                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Ссылка на Onlyfans Vip </label>

                                    <div class="col-sm-9">
                                        <input  class="form-control" name="onlyfans_free" id="emailLabel" placeholder="OnlyFansVip" aria-label="Email" value="{{$settings['onlyfans_vip']}}">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Ссылка на Funsly</label>

                                    <div class="col-sm-9">
                                        <input  class="form-control" name="fansly" id="emailLabel" placeholder="Funsly" aria-label="Email" value="{{$settings['fansly']}}">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Ссылка на Instagram </label>

                                    <div class="col-sm-9">
                                        <input  class="form-control" name="instagram" id="emailLabel" placeholder="Instagram" aria-label="Email" value="{{$settings['instagram']}}">
                                    </div>
                                </div>

                                <div class="row mb-4">
                                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Ссылка на Twitter </label>

                                    <div class="col-sm-9">
                                        <input  class="form-control" name="twitter" id="emailLabel" placeholder="Twitter" aria-label="Email" value="{{$settings['twitter']}}">
                                    </div>
                                </div>
